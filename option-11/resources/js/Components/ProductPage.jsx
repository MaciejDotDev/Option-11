...
export default function ProductPage({ product, auth, reviews, starsAvg, commentsCount, openModal }) {
    ...
    return (
        <>
            ...
            <Container className="mt-4">
                ...
                <div style={{ backgroundColor: "#212529", width: "60%", margin: "0 auto", marginTop: "2rem", borderRadius: "12px" }}>
                    <Tabs
                        defaultActiveKey="profile"
                        id="uncontrolled-tab-example"
                        className="mb-3"
                        style={{ width: "90%", margin: "0 auto", paddingTop: "1rem" }}
                    >
                        <Tab eventKey="description" title="Description" style={{ width: "60%", margin: "0 auto", color: "white", paddingBottom: "2rem" }}>
                            {product.products.description}
                        </Tab>
                        <Tab eventKey="delivery" title="Delivery options" style={{ width: "60%", margin: "0 auto", color: "white", paddingBottom: "2rem" }}>
                            Tab content for Profile
                        </Tab>
                        <Tab eventKey="contact" title="Contact" style={{ width: "60%", margin: "0 auto", color: "white", paddingBottom: "2rem" }}>
            ...
            <ReviewProducts reviews={reviews} starsAvg={starsAvg} commentsCount={commentsCount} auth={auth} productid={product.productid} click={onClickPreventDefault}></ReviewProducts>
